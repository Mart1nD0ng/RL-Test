...
class Observation:
    ...
    # Hard action masking: True when global edge count exceeds budget (3*N)
    # Actor should mask all ADD operations when this is True
    edge_budget_exceeded: bool = False
